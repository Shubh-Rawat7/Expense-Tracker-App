...
const TransactionModal = () => {
    ...
    const onSubmit = async () => {
        ...
        let trasanctionData: TransactionType = {
            type,
            amount,
            description,
            category,
        ...
        if (oldTransaction?.id) trasanctionData.id = oldTransaction.id;
        setLoading(true);
        const res = await createOrUpdateTransaction(trasanctionData);
            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.form} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.inputContainer}>
                        <Typo color={colors.neutral200} size={8}>Type</Typo>
                        <Dropdown
                    ...
                    {/* wallets */}
                    <View style={styles.inputContainer}>
                        <Typo color={colors.neutral200} size={8}>Wallet</Typo>
                        <Dropdown
                            style={styles.dropdownContainer}
                            activeColor={colors.neutral700}
                            placeholderStyle={styles.dropdownPlaceholder}
                    ...
                    {transaction.type == "expense" && (
                        <View style={styles.inputContainer}>
                            <Typo color={colors.neutral200} size={8}>Expense Category</Typo>
                            <Dropdown
                                style={styles.dropdownContainer}
                                activeColor={colors.neutral700}
                                placeholderStyle={styles.dropdownPlaceholder}
                    ...
                    {/* date picker */}
                    <View style={styles.inputContainer}>
                        <Typo color={colors.neutral200} size={8}>Date</Typo>
                        {!showDatePicker && (
                            <Pressable
                    ...
                    {/* amount */}
                    <View style={styles.inputContainer}>
                        <Typo color={colors.neutral200} size={8}>Amount</Typo>
                        <Input
                            // placeholder='Salary'
                    ...
                    <View style={styles.inputContainer}>
                        <View style={styles.flexRow}>
                            <Typo color={colors.neutral200} size={8}>Description</Typo>
                            <Typo color={colors.neutral500} size={7}>(optional)</Typo>
                        </View>
                    ...
                    <View style={styles.inputContainer}>
                        <View style={styles.flexRow}>
                            <Typo color={colors.neutral200} size={8}>Receipt</Typo>
                            <Typo color={colors.neutral500} size={7}>(optional)</Typo>
                        </View>
                        {/* image input */}
                        <ImageUpload
