  ...
  return (
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{ gap: spacingY._20, paddingBottom: verticalScale(100) }} showsVerticalScrollIndicator={false}>
          <SegmentedControl
          ...
          <View style={styles.chartContainer}>
            {chartData.length > 0 ? (
              <BarChart
                ...
                xAxisLabelTextStyle={{ color: colors.neutral350, fontSize: verticalScale(5) }}
                noOfSections={3}
                minHeight={5}
              // isAnimated={true}
