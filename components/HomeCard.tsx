            ...
            <View style={styles.container}>
                <View>
                    ...
                    <View style={styles.totalBalanceRow}>
                        <Typo color={colors.neutral800} size={8} fontWeight={"500"}>
                            Total Balance
                        </Typo>
                    ...
                    <Typo color={colors.black} size={15} fontWeight={"bold"}>
                    ...
                    <View style={{ gap: verticalScale(1) }}>
                        <View style={styles.incomeExpense}>
                            <View style={styles.statsIcon}>
                                <Icons.ArrowDown
                                    size={verticalScale(7)}
                                    color={colors.black}
                                    weight="bold"
                                />
                            </View>
                            <Typo size={8} color={colors.neutral700} fontWeight={"500"}>
                                Income
                            </Typo>
                        </View>
